...
const InitialValuesTableCell = ({colIdx, rowIdx, tdItem, onInputChange, type}: DisplayTableCellType): JSX.Element => {
    return (
        <td className="cell">
            ...
            {type === "customer" && (
                <>
                    <TableInputGroup inputLabel="Popyt"
                                     rowIdx={rowIdx}
                                     tdItem={tdItem}
                    ...
                    />
                    <TableInputGroup inputLabel="Sprzedaż"
                                     rowIdx={rowIdx}
                                     tdItem={tdItem}
                                     onInputChange={onInputChange}
                                     suffixText={'j.m.'}
            ...
            {type === "provider" && (
                <>
                    <TableInputGroup inputLabel="Zakup"
                                     rowIdx={rowIdx}
                                     tdItem={tdItem}
                                     onInputChange={onInputChange}
                                     suffixText={'j.m.'}
                    ...
                    />
                    <TableInputGroup inputLabel="Podaż"
                                     rowIdx={rowIdx}
                                     tdItem={tdItem}
                                     onInputChange={onInputChange}
                                     suffixText={'j.m.'}
