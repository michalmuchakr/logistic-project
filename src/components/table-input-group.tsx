...
const TableInputGroup = ({tdItem, inputLabel, onInputChange, suffixText, value, dataPropertyName, labelWidth=3,readOnly=false}: TableInputGroupType) => (
        <InputGroup className="mb-2" size="sm">
            <Form.Label column sm={labelWidth}>
                {inputLabel}
            </Form.Label>
            <FormControl placeholder="provide value"
                         value={value}
                         data-id={tdItem.id}
